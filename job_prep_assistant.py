...
print(f"🔍 Resume-to-JD Match Score: {score*100:.2f}%")

from IPython.display import Markdown

Markdown(f"### ✅ **Resume Match Score: {score*100:.2f}%**")
...
1. A match score (0 to 100) — your own estimate.
...
def highlight_missing_keywords(jd_text, resume_text):
    ...
    html = "<h4>🔍 <u>Job Description Keywords Match:</u></h4><br><p>"
    ...
    html += "</p><br><hr><p><b>Legend:</b> <span style='color:green;'>✔️ Present</span> | <span style='color:black;'>❌ Missing</span></p>"
...
# ✅ Score how many JD keywords appear in resume
